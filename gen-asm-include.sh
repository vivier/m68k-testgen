...
*                                                                             *
*                                                                             *
* This uses the GNU as to assemble the opcodes, then shadows them in          *
* opcodes.c and .h array to get pointers to them in 16 bit chunks.  We follow *
* the pointer to get to the assembled opcode until we hit a NULL.             *
*                                                                             *
\*****************************************************************************/
