...
WRITED2:
        nop
        movel #MYOPCODE,a0 
	addal #2,a0                  /* pack/unpack has a constant 16 bit value right after the opcode */
        movew d2,a0@                 /* write the constant */

        movel a6@(12),a0             /* Get pointer to reg1 -restore a0 */
        /* hope that we can flush the cache, but no guarantee here. */
	nop
	nop
	nop
	nop
