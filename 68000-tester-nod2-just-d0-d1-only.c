...
//d2--////////  for (k0=0;  (orgd2=test_pattern[k0])!=0xdeadbeef && skippy2<65536; k0++)  // only used if you have 3 operands! comment out otherwise.
  {
   int packflag=0;
  ...
  //d2-enabled//sprintf(pipecmd,"/usr/bin/gzip -1 >/mnt/next/m68040-opcode-%s.d2=%08x.bin.gz",text_opcodes[i],orgd2);
